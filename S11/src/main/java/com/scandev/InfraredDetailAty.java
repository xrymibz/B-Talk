    ...
    public void onBarcodeEvent(final BarcodeReadEvent barcodeReadEvent) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                //先判断，如果扫描结果不为空，则以下；否则做其他处理
                //似乎不用判断，若为空，就在onFailureEvent处理了，不会进到这里
    ...
    private OnClickListener mSendClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            for (int i = 0; i < ListNum; i++) {
                ...
                if (count.equals("")) {
                    Toast t = new Toast(InfraredDetailAty.this);
                    t = Toast.makeText(InfraredDetailAty.this, "请输入箱数", Toast.LENGTH_SHORT);
                    t.setGravity(Gravity.CENTER, 0, 0);
                    t.show();
                    success = false;
                    break;
